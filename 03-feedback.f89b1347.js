...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.clearForm=exports.printFormToConsole=exports.initLocalStorage=void 0;const o=o=>{let e=localStorage.getItem(o);return localStorage.getItem(o)?JSON.parse(e):{}};exports.initLocalStorage=o;const e=o=>{new FormData(o).forEach((o,e)=>console.log(`${e} => ${o}`))};exports.printFormToConsole=e;const t=o=>{o&&o.reset()};exports.clearForm=t;
...
"use strict";var e=require("./helpers.js");const t=document.querySelector(".feedback-form"),r="feedback-form-state";let a=(0,e.initLocalStorage)(r);const o=require("lodash/throttle");t.addEventListener("submit",a=>{a.preventDefault(),localStorage.removeItem(r),(0,e.printFormToConsole)(t),(0,e.clearForm)(t)}),t.addEventListener("change",o(e=>{a[e.target.name]=e.target.value,localStorage.setItem(r,JSON.stringify(a))},500)),document.addEventListener("DOMContentLoaded",()=>{a&&Object.entries(a).forEach(([e,r])=>t.elements[e].value=r)});
},{"./helpers.js":"EDcV","lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.f89b1347.js.map