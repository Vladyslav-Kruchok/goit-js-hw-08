...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.saveLocalStorage=exports.clearForm=exports.printFormToConsole=exports.initLocalStorage=void 0;const e=e=>{let o=localStorage.getItem(e);return localStorage.getItem(e)?JSON.parse(o):{}};exports.initLocalStorage=e;const o=e=>{new FormData(e).forEach((e,o)=>console.log(`${o} => ${e}`))};exports.printFormToConsole=o;const t=e=>{e&&e.reset()};exports.clearForm=t;const r=(e,o,t)=>{e[t.target.name]=t.target.value,localStorage.setItem(o,JSON.stringify(e))};exports.saveLocalStorage=r;
